...
angular.module('proiectApp', ['LocalStorageModule', 'tmh.dynamicLocale', 'pascalprecht.translate',
    ...
    .factory('rewriteInterceptor', ['$q', function($q) {
    ...
    .config(['$urlMatcherFactoryProvider', '$httpProvider',  function($urlMatcherFactory, $httpProvider) {
