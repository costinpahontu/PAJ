...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "proiect@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "proiect API";

        private String description = "proiect API documentation";
